        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner" style="margin-left:38%">
              <div class="carousel-item active">
                <img src="./assets/images/k.jpg" class="d-block  " style="height:350px" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./assets/images/chanel.jpg" class="d-block" style="height:350px" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./assets/images/black.jpg" class="d-block" style="height:350px" alt="...">
              </div>
            </div>
          ...
          <div class="row my-3">
              <div class="col-8">
                <div class="row row-cols-1 row-cols-md-2 g-4">
                    ...
                    <div class="col">
                      <div class="card">
                        <img src="./assets/images/<?=$parf->getImage();?>" class="card-img-top" style="height: 350px;" alt="...">
                        <div class="card-body">
                          <h5 class="bg-secondary text-center text-white card-title"> <?=strtoupper($parf->getCategorie()->getNom_cat());?>:  <?=$parf->getMarque();?></h5>
                          <p class="card-text"><?=$parf->getDescription();?></p>
                          <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                             Modèle:
                              <span class="badge text-primary rounded-pill"><?=$parf->getModele();?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                            Contenance:
                              <span class="badge text-primary rounded-pill"><?=$parf->getContenance();?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                             Prix:
                              <span class="badge bg-primary rounded-pill"><?=$parf->getPrix();?> €</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                              Quantité:
                              <span class="badge bg-primary rounded-pill"><?=$parf->getQuantite();?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
