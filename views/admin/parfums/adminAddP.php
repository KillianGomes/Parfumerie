<?php ob_start();?>
 ...
 <div class="container">
     <div class="row">
         ...
         <h1 class="display-6 text-center text-secondary text-decoration-underline">Ajout d'un Parfum:</h1>
             <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" id="contenance" name="contenance" class="form-control" placeholder="la contenance" >
                    </div>
                </div>
                <div class="row">
                    <div class="col">
