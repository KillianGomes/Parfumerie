<?php ob_start();?>
 ...
 <div class="container">
     <div class="row">
         ...
         <h1 class="display-6 text-center text-decoration-underline text-secondary">Ajout d'un Utilisateurs</h1>
             <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-secondary  col-12 mt-2" name="soumis">Soumettre</button>
            </form>
         </div>
     </div>
 </div>
