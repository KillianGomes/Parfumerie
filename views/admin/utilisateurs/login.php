  ...
  <div class="container ">
       <div class="row">
           <div class="col-6 offset-3">
              <h1 class="display-6 text-center  text-decoration-underline text-secondary">Formulaire de connexion</h1>
              <?php if(isset($error)){ ?>
              ...
              <?php } ?>
               <form action="<?php $_SERVER['PHP_SELF'];?>" method="post">
                  ...
                  <button type="submit" class="btn btn-secondary  col-12 mt-2" name="soumis">Se connecter</button>
                  </form>
           </div>
       </div>
   </div>
